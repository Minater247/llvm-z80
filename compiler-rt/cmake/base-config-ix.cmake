...
macro(test_targets)
  ...
  elseif(NOT APPLE) # Supported archs for Apple platforms are generated later
    ...
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "ez80")
      test_target_arch(ez80 "" --target=ez80-none-elf -D__HAVE_FLOAT128=0)
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "z80")
      test_target_arch(z80 "" --target=z80-none-elf -D__HAVE_FLOAT128=0)
    endif()
